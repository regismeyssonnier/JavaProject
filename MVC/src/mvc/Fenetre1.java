 ...
 * @author Régis
 */
public class Fenetre1 extends JFrame implements Observer{
    ...
    public Fenetre1(Modeletemperature mt){
            ...
            text.setText(String.valueOf(mt.getTemperatureF()));
    ...
    public void IncrementerActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        this.mt.setTempF(this.mt.getTemperatureF()+1);
    ...
    public void update(Observable o, Object arg) {
        ...
        if(o == this.mt)
        {
            text.setText(String.valueOf(this.mt.getTemperatureF()));
        }
